...
<head>
    ...
    <title>Update Complaint Information</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h2>Update Complaint Information</h2>
        <form action="update_complaint_process.php" method="post">
            <label for="complaintid">Complaint ID:</label>
            <input type="text" id="complaintid" name="complaintid" required>

            <label for="resolutiondate">Updated Date of Resolution:</label>
