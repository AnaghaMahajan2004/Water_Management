...
<html>
<head>
    <title>Print Meter Information</title>
...
<table id="meterTable" border="1" style="display:none;">
    <thead>
        <tr>
            <th>Meter_Id</th>
            <th>Customer_Id</th>
...
<script>
    function downloadPDF() {
        ...
        doc.autoTable({ html: '#meterTable' });
        doc.save('meter_information.pdf');
    }
