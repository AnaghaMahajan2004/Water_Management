...
<head>
    ...
    <title>Update Water Source Information</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h2>Update Water Source Information</h2>
        <form action="update_water_source_process.php" method="post">
            <label for="sourceid">Source ID:</label>
            <input type="text" id="sourceid" name="sourceid" required>

            <label for="capacity">Updated Capacity:</label>
